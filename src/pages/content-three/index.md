# ![Markdown Intro](./static/img/webpack.png)
...
```html
<p>引用式 <a href="123">博客</a> 链接。</p>

<p>引用式 <a href="123" title="我的 GitHub 主页">GitHub</a> 链接，带 title。</p>
```
...
```
![Alt text](https://123.org/favicon.ico "favicon")
```
...
```html
<img src="https://123.org/favicon.ico" alt="Alt text" title="favicon">
```
