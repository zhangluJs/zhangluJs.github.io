...
* 2018/12/27
    * 这一个多月折腾的vue个人项目终于上线了，是自己第一个个人上线的项目，还是很开心的。不过目前有一些小瑕疵，但是我已经很满足了。访问地址，这是一个[链接](zhangluupup.top)。  现在折腾一下这个react项目，昨天刚把webpack配置项改好，虽然很简单，但是dev、build都已经没问题了:+1:。